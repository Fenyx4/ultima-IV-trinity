...
int bp04;
{
	...
	do {
		...
		if(bp_12[0] == 0)
			break;
        /*could add a global value here that adjusts according to the influence of the trinity, making everyone nastier and nastier? Could use Orb_Check(), to make it work, cheaply*/
        /*This code is just sample of using the unused section of D_95CE to make different flags for global behaviors*/
        /*if(!Orb_Check() && (D_95CE[1] == 0x10)){
            u4_puts(D_8CCE[1]);
            u4_puts(" says: On guard! Fool!\n");
		...
		if((si = u_rand_a()) < D_95CE[2]) {
			if(D_95CE[2] - si >= 0x40) {
				/*he/she gets upset*/
				if(strnicmp(D_8CCE[0], "a ", 2) && strnicmp(D_8CCE[0], "the ", 4))
					u4_puts(D_8CCE[0]);
				else
					u4_puts(D_8CCE[1]);
				u4_puts(" says: On guard! Fool!\n");
...
unsigned char D_2CD4[][10] = {
	{0x00,0x00,0x00,0x00,0x00,0x1A,0x00,0x00,0x00,0x19},/*LB*/

	{0x00,0x00,0x00,0x00,0x00,0x0C,0x00,0x00,0x00,0x00},/*lycaeum*/
	{0x00,0x00,0x00,0x00,0x00,0x0F,0x00,0x00,0x00,0x00},/*empath*/
	{0x00,0x00,0x00,0x00,0x00,0x0C,0x00,0x00,0x00,0x00},/*serpent*/

	{0x00,0x00,0x0E,0x00,0x1A,0x1B,0x02,0x00,0x00,0x00},/*MOONGLOW*/
	{0x03,0x07,0x06,0x02,0x00,0x1D,0x0C,0x00,0x00,0x00},/*BRITAIN*/
	{0x09,0x05,0x00,0x13,0x00,0x06,0x1A,0x00,0x00,0x00},/*JHELOM*/
	{0x00,0x00,0x18,0x00,0x00,0x19,0x00,0x00,0x00,0x00},/*YEW.ULT*/
	{0x1C,0x00,0x00,0x00,0x00,0x00,0x03,0x00,0x00,0x00},/*MINOC*/
	{0x14,0x18,0x00,0x02,0x00,0x00,0x03,0x00,0x00,0x00},/*TRINSIC*/
	{0x00,0x00,0x11,0x00,0x04,0x1B,0x0D,0x00,0x00,0x00},/*SKARA*/
	{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*MAGINCIA*/

	{0x00,0x04,0x1A,0x05,0x07,0x00,0x00,0x00,0x18,0x00},/*paws*/
	{0x0B,0x11,0x00,0x19,0x08,0x00,0x00,0x07,0x00,0x00},/*den*/
	{0x14,0x00,0x00,0x16,0x00,0x00,0x15,0x1A,0x00,0x00},/*vesper*/
	{0x00,0x00,0x00,0x00,0x00,0x1A,0x00,0x00,0x00,0x00}, /*cove*/
    ...
    {0x00,0x00,0x00,0x0A,0x00,0x00,0x00,0x0C,0x00,0x00},/*riverca*/
    {0x00,0x00,0x00,0x00,0x11,0x00,0x00,0x00,0x00,0x00},/*forestca*/
    {0x00,0x00,0x00,0x00,0x00,0x1C,0x00,0x00,0x00,0x00},/*mountca*/
    {0x00,0x00,0x0F,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*swampca*/
    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*plainsca*/
    {0x00,0x08,0x00,0x00,0x0E,0x00,0x00,0x00,0x00,0x00},/*Valleyca*/
    {0x00,0x00,0x13,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*farmca*/
    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x00}/*ranchca*/
};
