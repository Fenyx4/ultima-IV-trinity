...
/*added entries for all shapes for three sprite NPCs */
unsigned char D_2F72[] = {
    ...
    0x07,0x07,0x07,0x07,0x07,0x07,0x07,0x05,0x05,0x05,0x05,0x05,0x05,0x05,0x05,0x05
};
...
unsigned bp04;
{
	...
	for(loc_C = 0; loc_C < 32; loc_C++) {
        ...
        /*added case for new shapes added after switching to 3 shape NPCS */
		if(D_8742._map.x32x32[loc_A][loc_C] < 0x80 || D_8742._map.x32x32[loc_A][loc_C] > 0xE1) {
