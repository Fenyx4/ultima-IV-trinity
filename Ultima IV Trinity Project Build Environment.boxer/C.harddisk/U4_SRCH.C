...
C_TELE()
{
	...
	if(Load(Towne_Castle_Village[bp_02], sizeof(tMap32x32), &(D_8742._map)) == -1)
		exit(3);
	PER_World(0);
    if(Load(Second_Floor[Party._loc - 0x01 + ((Party._z + 1)* 40)], sizeof(struct t_500), &D_8742) == -1)
		exit(3);
}
...
struct t_05_local {
	unsigned char _00, _01, _02, _03;
	pS_handler _04;
} D_2920[] = {
	{0x00,0x52,0x69,0x00,C_MAND},/*Mandrake root*/
    /*{0x00,0xB6,0x36,C_MAND},/*Mandrake root*/

	{0x00,0x64,0xA5,0x00,C_MAND},/*Mandrake root*/
    {0x00,0x62,0x9D,0x00,C_MAND},/*New Mandrake root location*/
    
	{0x00,0x54,0x69,0x00,C_NIGH},/*Nightshade*/
    /*{0x00,0x2E,0x95,C_NIGH},/*Nightshade*/
    
	{0x00,0xCD,0x2C,0x00,C_NIGH},/*Nightshade*/
	{0x00,0xB0,0xD0,0x00,C_BELL},/*The Bell of Courage!*/
	{0x00,0x2D,0xAD,0x00,C_HORN},/*'A Silver Horn!'*/
    {0x00,0x56,0x67,0x00,C_BELT},/*'A Strange Belt!'*/
    {0x00,0x58,0x6C,0x00,C_RING},/*'A Strange Ring!'*/
    {0x00,0x58,0x6B,0x00,C_MBOW},/*Mystic Bows!*/
	{0x00,0x58,0x67,0x00,C_WHEL},/*The Wheel from the H.M.S. Cape!*/
    /*{0x00,0x60,0xD7,C_WHEL},The Wheel from the H.M.S. Cape!*/
    
    /*{0x00,0xC5,0xF5,C_SKUL},The Skull of Mondain the Wizard!*/

	{0x00,0x5A,0x67,0x00,C_SKUL},/*The Skull of Mondain the Wizard!*/
    {0x00,0x59,0x6B,0x00,C_WAND},/*The Wand of Minax the Enchantress!*/
	{0x00,0xE0,0x85,0x00,C_BLAC},/*The Black Stone!*/
	{0x00,0x40,0x50,0x00,C_WHIT},/*The White Stone!*/
	{0x02,0x06,0x06,0x00,C_BOOK},/*The Book of Truth!*/
	{0x10,0x16,0x01,0x00,C_CAND},/*The Candle of Love!*/
	{0x02,0x16,0x03,0x00,C_TELE},/*use Telescope*/
    {0x00,0x52,0x67,0x00,C_MYAR},/*Mystic Armour!*/
    {0x00,0x54,0x67,0x00,C_MYWE},/*Mystic Weapons!*/
	/*{0x03,0x16,0x04,C_MYAR},
	{0x04,0x08,0x0F,C_MYWE},*/
	{0x05,0x08,0x06,0x00,C_90C5},/*rune of ...*/
	{0x06,0x19,0x01,0x00,C_90C5},/*rune of ...*/
	{0x07,0x1E,0x1E,0x00,C_90C5},/*rune of ...*/
	{0x08,0x0D,0x06,0x00,C_90C5},/*rune of ...*/
	{0x09,0x1C,0x1E,0x00,C_90C5},/*rune of ...*/
	{0x0A,0x02,0x1D,0x00,C_90C5},/*rune of ...*/
	{0x01,0x11,0x08,0x00,C_90C5},/*rune of ...*/
	{0x0D,0x1D,0x1D,0x00,C_90C5},/*rune of ...*/
    {0x00,0x50,0x66,0x00,C_ORB1},/*An Orb of the Moon!*/
    {0x00,0x52,0x66,0x00,C_ORB2},/*An Orb of the Moon!*/
    {0x00,0x54,0x66,0x00,C_ORB3},/*An Orb of the Moon!*/
    {0x25,0x13,0x0F,0x03,C_TELE},/*use Telescope new*/
...
/*C_913A*/CMD_Search()
{
	...
	for(si = D_2920; si->_04; si ++) {
		if(si->_00 == Party._loc && si->_01 == Party._x && si->_02 == Party._y && si->_03 == Party._z)
			break;
	}
	if(si->_04 == 0) {
		u4_puts(D_27A6);
